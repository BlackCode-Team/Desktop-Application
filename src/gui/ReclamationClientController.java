...
public class ReclamationClientController implements Initializable {
        ...
        void envoyer(ActionEvent event) throws IOException {
            ...
            if(chboxvehicule.getValue() == null || txtcontenu.getText().isEmpty()) {
                ...
                observableListReclamations.addAll(rs.afficherentiteClient());
        ...
        public void consulter() {
            List<Reclamation> listReclamations = rs.afficherentiteClient();
        ...
        public void initialize(URL url, ResourceBundle resourceBundle) {
            ...
            consulter();
            List<String> matricules = rs.afficherVehiculesReservees();
