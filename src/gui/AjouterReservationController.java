...
import static gui.SignIn_SignOutController.currentuser;
import static javafx.application.Application.launch;
import static services.ItineraireService.currentidit;
...
//                int vehiculeId = reservationService.getVehiculeIdByMatricule(matricule);
    ...
    public void setReservation(Reservation res) {
        reservation = res;
        clienttxt.setText(String.valueOf(currentuser));
        vehiculetxt.setText(Integer.toString(res.getIdvehicule()));
        itinerairetxt.setText(Integer.toString(it.selectionParId(currentuser)));
    ...
    void setIdItin(int iditin) {
        this.iditin = iditin;
        System.out.println("iditneraire " + currentidit);
        itinerairetxt.setText(Integer.toString(it.selectionParId(currentuser)));
    }

    public void setIduser(int iduser) {
        clienttxt.setText(Integer.toString(currentuser));
